...
export const ClothingProvider = ({ children }) => {
  const [clothingItems, setClothingItems] = useState([
    ...
    { id: 14, name: "Green Army Pants", img: Clothes.unibottom2, color: "green", occasion: "music-festival", gender: "unisex", aesthetic: "streetwear", category: "bottom"},
    { id: 15, name: "Brown Shorts", img: Clothes.unibottom3, color: "brown", occasion: "music-festival", gender: "unisex", aesthetic: "casual", category: "bottom"},
    ...
    { id: 19, name: "White Short-Sleeve Shirt", img: Clothes.masctop1, color: "white", occasion: "music-festival", gender: "masculine", aesthetic: "casual", category: "top"},
    { id: 20, name: "Grey Ribbed Polo", img: Clothes.masctop2, color: "grey", occasion: "music-festival", gender: "masculine", aesthetic: "clean", category: "top"},
    { id: 21, name: "Floral White Shirt", img: Clothes.masctop3, color: "multi", occasion: "music-festival", gender: "masculine", aesthetic: "fun", category: "top"},
    ...
    { id: 26, name: "Navy Blue Canvas", img: Clothes.mascshoe2, color: "bluee", occasion: "music-festival", gender: "masculine", aesthetic: "casual", category: "shoe"},
